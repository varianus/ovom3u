...
type
 ...
 //   fBackEnd: tBackEnd;
    ...
    procedure SetOnMmKey(AValue: MmKey);
  public
...
uses LoggerUnit,URIParser, DbusExtension;
...
const
  Introspect_xml =
    ...
    ' ''http://www.freedesktop.org/standards/dbus/1.0/introspect.dtd''>' + #10 +
    '<node>' + #10 +
    '	<interface name=''org.freedesktop.DBus.Introspectable''>' + #10 +
    '	  <method name=''Introspect''>' + #10 +
    '	    <arg name=''data'' direction=''out'' type=''s''/>' + #10 +
    '   </method>' + #10 +
    '	</interface>' + #10 +
    '	<interface name=''org.freedesktop.DBus.Properties''>' + #10 +
    '		<method name=''Get''>' + #10 +
    '			<arg name=''interface'' direction=''in'' type=''s''/>' + #10 +
    '			<arg name=''property'' direction=''in'' type=''s''/>' +  #10 +
    '			<arg name=''value'' direction=''out'' type=''v''/>' + #10 +
    '		</method>' + #10 +
    '		<method name=''GetAll''>' +  #10 +
    '			<arg name=''interface'' direction=''in'' type=''s''/>' + #10 +
    '			<arg name=''properties'' direction=''out'' type=''a{sv}''/>' + #10 +
    '		</method>' + #10 +
    '	</interface>' + #10 +
    '	<interface name=''org.mpris.MediaPlayer2''>' + #10 +
    '		<method name=''Raise''/>' + #10 +
    '		<method name=''Quit''/>' + #10 +
    '		<property name=''CanQuit'' type=''b'' access=''read'' />' + #10 +
    '		<property name=''Fullscreen'' type=''b'' access=''readwrite'' />' + #10 +
    '		<property name=''CanRaise'' type=''b'' access=''read'' />' + #10 +
    '		<property name=''HasTrackList'' type=''b'' access=''read''/>' +  #10 +
    '		<property name=''Identity'' type=''s'' access=''read''/>' + #10 +
    '		<property name=''DesktopEntry'' type=''s'' access=''read''/>' +  #10 +
    '		<property name=''SupportedUriSchemes'' type=''as'' access=''read''/>' + #10 +
    '		<property name=''SupportedMimeTypes'' type=''as'' access=''read''/>' + #10 +
    '	</interface>' + #10 +
    '	<interface name=''org.mpris.MediaPlayer2.Player''>' + #10 +
    '		<method name=''Next''/>' + #10 +
    '		<method name=''Previous''/>' + #10 +
    '		<method name=''Pause''/>' + #10 +
    '		<method name=''PlayPause''/>' + #10 +
    '		<method name=''Stop''/>' + #10 +
    '		<method name=''Play''/>' + #10 +
    '		<method name=''Seek''>' + #10 +
    '			<arg direction=''in'' name=''Offset'' type=''x''/>' + #10 +
    '		</method>' + #10 +
    '		<method name=''SetPosition''>' + #10 +
    '			<arg direction=''in'' name=''TrackId'' type=''o''/>' + #10 +
    '			<arg direction=''in'' name=''Position'' type=''x''/>' + #10 +
    '		</method>' + #10 +
    '		<method name=''OpenUri''>' + #10 +
    '			<arg direction=''in'' name=''Uri'' type=''s''/>' + #10 +
    '		</method>' + #10 +
    '		<signal name=''Seeked''>' + #10 +
    '			<arg name=''Position'' type=''x''/>' + #10 +
    '		</signal>' + #10 +
    '		<property name=''PlaybackStatus'' type=''s'' access=''read''/>' + #10 +
    '		<property name=''LoopStatus'' type=''s'' access=''readwrite''/>' + #10 +
    '		<property name=''Rate'' type=''d'' access=''readwrite''/>' + #10 +
    '		<property name=''Shuffle'' type=''b'' access=''readwrite''/>' + #10 +
    '		<property name=''Metadata'' type=''a{sv}'' access=''read''/>' + #10 +
    '		<property name=''Volume'' type=''d'' access=''readwrite''/>' + #10 +
    '		<property name=''Position'' type=''x'' access=''read''/>' + #10 +
    '		<property name=''MinimumRate'' type=''d'' access=''read''/>' + #10 +
    '		<property name=''MaximumRate'' type=''d'' access=''read''/>' + #10 +
    '		<property name=''CanGoNext'' type=''b'' access=''read''/>' + #10 +
    '		<property name=''CanGoPrevious'' type=''b'' access=''read''/>' + #10 +
    '		<property name=''CanPlay'' type=''b'' access=''read''/>' + #10 +
    '		<property name=''CanPause'' type=''b'' access=''read''/>' + #10 +
    '		<property name=''CanSeek'' type=''b'' access=''read''/>' + #10 +
    '		<property name=''CanControl'' type=''b'' access=''read''/>' + #10 +
    '	</interface>' + #10 +
    '	<interface name=''org.mpris.MediaPlayer2.TrackList''>' + #10 +
    '		<method name=''GetTracksMetadata''>' + #10 +
    '			<arg direction=''in'' name=''TrackIds'' type=''ao''/>' + #10 +
    '			<arg direction=''out'' name=''Metadata'' type=''aa{sv}''>' + #10 +
    '			</arg>' + #10 +
    '		</method>' + #10 +
    '		<method name=''AddTrack''>' + #10 +
    '			<arg direction=''in'' name=''Uri'' type=''s''/>' + #10 +
    '			<arg direction=''in'' name=''AfterTrack'' type=''o''/>' + #10 +
    '			<arg direction=''in'' name=''SetAsCurrent'' type=''b''/>' + #10 +
    '		</method>' + #10 +
    '		<method name=''RemoveTrack''>' + #10 +
    '			<arg direction=''in'' name=''TrackId'' type=''o''/>' + #10 +
    '		</method>' + #10 +
    '		<method name=''GoTo''>' + #10 +
    '			<arg direction=''in'' name=''TrackId'' type=''o''/>' + #10 +
    '		</method>' + #10 +
    '		<signal name=''TrackListReplaced''>' + #10 +
    '			<arg name=''Tracks'' type=''ao''/>' + #10 +
    '			<arg name=''CurrentTrack'' type=''o''/>' + #10 +
    '		</signal>' + #10 + '		<signal name=''TrackAdded''>' + #10 +
    '			<arg name=''Metadata'' type=''a{sv}''>' + #10 +
    '			</arg>' + #10 +
    '			<arg name=''AfterTrack'' type=''o''/>' + #10 +
    '		</signal>' + #10 +
    '		<signal name=''TrackRemoved''>' + #10 +
    '			<arg name=''TrackId'' type=''o''/>' + #10 +
    '		</signal>' + #10 +
    '		<signal name=''TrackMetadataChanged''>' + #10 +
    '			<arg name=''TrackId'' type=''o''/>' + #10 +
    '			<arg name=''Metadata'' type=''a{sv}''>' + #10 +
    '			</arg>' + #10 + '		</signal>' + #10 +
    '		<property name=''Tracks'' type=''ao'' access=''read''/>' + #10 +
    '		<property name=''CanEditTracks'' type=''b'' access=''read''/>' + #10 +
    '	</interface>' + #10 +
    '</node>';


const
  BUS_NAME = 'org.mpris.MediaPlayer2.ovom3u';


{ TMpris2 }

procedure append_metadata_array(messageIter: PDBusMessageIter);
var
...
begin
  ...
  dbus_message_iter_append_basic(@dict_entry, DBUS_TYPE_STRING, @property_);
  s_val := 'canale corrente';//PChar(tags.title);
  dbus_message_iter_open_container(@dict_entry, DBUS_TYPE_VARIANT, 's', @dict_val);
  dbus_message_iter_append_basic(@dict_val, DBUS_TYPE_STRING, @s_val);
  dbus_message_iter_close_container(@dict_entry, @dict_val);
  dbus_message_iter_close_container(@dict, @dict_entry);
...
var
  ...
  Procedure SendKey(Key: word);
   Var
     wp: word;
   begin
     if assigned(TMpris2(user_data).FOnMmKey) then
     begin
       wp := $200 + Key;
       TMpris2(user_data).FOnMmKey(Tobject(user_data), wp);
     end;
...
function TMpris2.Activate: boolean;
var
  Error: DBusError;
  Match, Path: PChar;
begin
...
//    exit;
  ...
  if (mpris_connection = nil) then
    begin
      OvoLogger.Log(llERROR, 'Failed to open connection to %s message bus: %s', ['session', error.message]);
      dbus_error_free(@error);
      Result := False;
      exit;
    end;
...
procedure TMpris2.UpdateProperty;
begin
  //case kind of
  //  cpStatus:
  //    begin
...
begin
  if (mpris_connection <> nil) then
    ...
    dbus_message_iter_init_append(message, @iter);
    x_val := 0;//fbackend.Position * 1000000;
...
procedure TMpris2.SetOnMmKey(AValue: MmKey);
begin
  FOnMmKey:=AValue;
end;
