...
$INSTALLFILE  $BASE/src/language/ovom3u.$1.po $DEBSRCDIR/usr/share/locale/$1/LC_MESSAGES/ovom3u.po
}
...
$INSTALLFILE  $BASE/src/images/ovom3u.png $DEBSRCDIR/usr/share/pixmaps/ovom3u.png
...
##gzip -c --best $BASE/DOC/manpages/ovoplayer.1 > $DEBSRCDIR/usr/share/man/man1/ovom3u.1.gz
